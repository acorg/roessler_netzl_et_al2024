...
figure_dir <- file.path("som", "subset_sr_groups_map")
# load data
...
map_files <- map_files[!(grepl("alignment|threshold1", map_files))]
map_files <- map_files[(grepl("map_threshold20_all_ags_singleTP_woXBBBQ11conv_alpha_adj", map_files))]
