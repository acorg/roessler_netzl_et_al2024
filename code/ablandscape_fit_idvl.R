...
use_multi_fit_cone_params <- TRUE
...
# make individual landscapes
# assign landscape parameters from multi fit
# set cone coordinates of mean fit landscapes to the cone coordinates of the individual

if(use_multi_fit_cone_params){
  ...
  # here if we want to fit idvl landscapes
...
saveRDS(lndscp_list, paste0("data/landscape_fit/idvl_fits_ags_",fit_ags,".rds"))
